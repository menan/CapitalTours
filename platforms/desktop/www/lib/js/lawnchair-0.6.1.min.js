...
JSON.stringify(f))},find:function(b){for(var d=this.all(),f=0,g=d.length;f<g;f++)if(b===d[f])return f;return false}};c&&this.fn(this.name,c).call(this,this)},save:function(a,c){var e=a.key||this.uuid();!(this.indexer.find(e)===false)||this.indexer.add(e);delete a.key;this.storage.setItem(e,JSON.stringify(a));if(c){a.key=e;this.lambda(c).call(this,a)}return this},batch:function(a,c){for(var e=[],b=0,d=a.length;b<d;b++)this.save(a[b],function(f){e.push(f)});c&&this.lambda(c).call(this,e);return this},keys:function(){callback&&
