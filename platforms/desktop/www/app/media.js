...
function prepMediaPages() {
	(function(window, $, PhotoSwipe){
      ...
      // //console.log("IN SHOW BLOCK", e.target);
        ...
        var options = { 
					...
					// This block was causing problems (ISSUE 4). Will cycle back and re-add once the list has been managed. Rob E.
          // if(fsGallery.get() == 'yes') {
        ...
        // //console.log("IN HIDE BLOCK", e.target);
				var currentPage = $(e.target);
